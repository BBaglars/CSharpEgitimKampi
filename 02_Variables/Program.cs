...
namespace _02_Variables
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //    appleGram + " - Toplam Tutar: " + appleTotalPrice + " TL");

            //Console.WriteLine("Alınan Ürün: Portakal - " + "Birim Fiyat: " + orangePrice + " + Gramaj: " +
            //    orangeGram + " - Toplam Tutar: " + orangeTotalPrice + " TL");

            //Console.WriteLine("Alınan Ürün: Çilek - " + "Birim Fiyat: " + strawberryPrice + " + Gramaj: " +
            //    strawberryGram + " - Toplam Tutar: " + strawberryTotalPrice + " TL");

            //Console.WriteLine("Alınan Ürün: Patates - " + "Birim Fiyat: " + potatoPrice + " + Gramaj: " +
            //    potatoGram + " - Toplam Tutar: " + potatoTotalPrice + " TL");

            //Console.WriteLine("Alınan Ürün: Domates - " + "Birim Fiyat: " + tomatoPrice + " + Gramaj: " +
            //    tomatoGram + " - Toplam Tutar: " + tomatoTotalPrice + " TL");

            //double shoppineTotalPrice = appleTotalPrice + orangeTotalPrice + strawberryTotalPrice +
            //    potatoTotalPrice + tomatoTotalPrice;

            //Console.WriteLine();
            //Console.WriteLine();

            //Console.WriteLine("Alışveriş Toplam Tutarı: " + shoppineTotalPrice + " TL");
            ...
            //Console.WriteLine("Yolcu Şehir : " + passengerDistrict + " / " + passengerCity);
            //Console.WriteLine("-----------------------------------------------");
